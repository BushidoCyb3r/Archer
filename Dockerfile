...
ENTRYPOINT ["/sbin/tini", "--", "/app/entrypoint.sh"] # nosemgrep: dockerfile.security.missing-user-entrypoint
CMD ["--tls-addr=:8443", "--logs-dir=/logs"] # nosemgrep: dockerfile.security.missing-user
